import { LocalSubjectStore, SubjectStore } from './store';
...
class ObjectStore extends SubjectStore<State> {
...
class ArrayStore extends SubjectStore<number[]> {
...
class TestLocalStore extends LocalSubjectStore<State> {
